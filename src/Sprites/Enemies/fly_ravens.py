...
class FlyRaven(Enemy):
    ...
    def load_sprites(self):
        self.enemy_frames_right = [pygame.image.load(f"assets/Raven Bird/FlyRight{i}.png").convert_alpha() for i in range(1, 7)]
        self.enemy_frames_left = [pygame.image.load(f"assets/Raven Bird/FlyLeft{i}.png").convert_alpha() for i in range(1, 7)]
