...
from UI.enemy_health import EnemyHealth
...
class GroundRaven(Enemy):
    ...
    def load_sprites(self):
        self.enemy_frames_right = [pygame.image.load(f"assets/Raven/RunRight{i}.png").convert_alpha() for i in range(1, 9)]
        self.enemy_frames_left = [pygame.image.load(f"assets/Raven/RunLeft{i}.png").convert_alpha() for i in range(1, 9)]
