...
class Level3(Game):
    ...
    def play(self):
        ...
        if (
            self.game_score.ground_ravens_kills == 10
    ...
    def display_objective(self, screen):
        ...
        objective2_text = self.game_font.render(
            f"- Kill 3 Fly Ravens", True, "Black"
        ).convert_alpha()
    ...
    def display_level(self, screen):
        ...
        # Text
        level_text = self.game_font.render("Level 3", True, "Black").convert_alpha()
        ...
        objective_text = self.game_font.render(
            ...
            True,
            "green" if self.game_score.ground_ravens_kills == 10 else "black",
        ).convert_alpha()
        ...
        objective2_text = self.game_font.render(
            ...
            True,
            "green" if self.game_score.fly_ravens_kills == 3 else "black",
        ).convert_alpha()
