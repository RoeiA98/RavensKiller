...
class Level4(Game):
    ...
    def display_level(self, screen):
        ...
        # Text
        level_text = self.game_font.render("Level 4", True, "Black").convert_alpha()
        ...
        objective_text = self.game_font.render(
            ...
            True,
            "green" if self.game_score.fly_ravens_kills == 10 else "black",
        ).convert_alpha()
